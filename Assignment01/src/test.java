...
class test {
	...
	/*
	 * @Test //Test viewing timetable //This test is expected to pass as there is a
	 * record for ISYS1118 in the database. void testTimetable() { Timetable
	 * timetable = new Timetable(); String result =
	 * timetable.viewTimetable("ISYS1118");
	 * assertEquals("ID: 1 FirstName: Bill LastName: Billson Date: 1/08/2018 Time:04:00"
	 * , result); }
	 * 
	 * //Test input rates
	 * 
	 ...
	 * 
	 * @Test void inputRates() { Rates rates = new Rates(); String result =
	 * rates.inputRates(); assertEquals("Data imported successfully",result); }
	 */
	 ...
	 * 
	 * void apply() { Availability availability = new Availability(); boolean result
	 * = availability.apply("ISYS1118", "e123123"); assertTrue(result); }
	 */
